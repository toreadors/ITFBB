...
$mysqli->query("CREATE TABLE infos(id INT AUTO_INCREMENT PRIMARY KEY,text VARCHAR(512),titel VARCHAR(64), threadid INT UNIQUE KEY, timestamp TIMESTAMP, userid INT(10))");
